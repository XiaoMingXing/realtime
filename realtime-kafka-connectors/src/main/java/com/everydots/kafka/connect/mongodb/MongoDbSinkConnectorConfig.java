...
import com.everydots.kafka.connect.mongodb.cdc.debezium.mongodb.MongoDbHandler;
import com.everydots.kafka.connect.mongodb.cdc.debezium.mysql.MysqlHandler;
import com.everydots.kafka.connect.mongodb.processor.*;
import com.everydots.kafka.connect.mongodb.processor.field.projection.FieldProjector;
import com.everydots.kafka.connect.mongodb.processor.field.renaming.FieldnameMapping;
import com.everydots.kafka.connect.mongodb.processor.field.renaming.RegExpSettings;
import com.everydots.kafka.connect.mongodb.processor.field.renaming.RenameByRegExp;
import com.everydots.kafka.connect.mongodb.processor.id.strategy.*;
...
public class MongoDbSinkConnectorConfig extends AbstractConfig {
    ...
    public static final String MONGODB_DOCUMENT_ID_STRATEGY_DEFAULT = "com.everydots.kafka.connect.mongodb.processor.id.strategy.BsonOidStrategy";
    ...
    public static final String MONGODB_POST_PROCESSOR_CHAIN_DEFAULT = "com.everydots.kafka.connect.mongodb.processor.DocumentIdAdder";
