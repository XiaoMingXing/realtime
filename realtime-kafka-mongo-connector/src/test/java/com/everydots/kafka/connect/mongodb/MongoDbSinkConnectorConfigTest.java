...
import com.everydots.kafka.connect.mongodb.processor.BlacklistValueProjector;
import com.everydots.kafka.connect.mongodb.processor.DocumentIdAdder;
import com.everydots.kafka.connect.mongodb.processor.PostProcessor;
import com.everydots.kafka.connect.mongodb.processor.WhitelistValueProjector;
import com.everydots.kafka.connect.mongodb.processor.field.renaming.RenameByMapping;
...
public class MongoDbSinkConnectorConfigTest {
    ...
    public void getBuildPostProcessorChainInvalid() {
        ...
        HashMap<String, String> map2 = new HashMap<>();
        map2.put(MongoDbSinkConnectorConfig.MONGODB_POST_PROCESSOR_CHAIN,
                "com.everydots.kafka.connect.mongodb.MongoDbSinkTask");
        MongoDbSinkConnectorConfig cfg2 = new MongoDbSinkConnectorConfig(map2);
